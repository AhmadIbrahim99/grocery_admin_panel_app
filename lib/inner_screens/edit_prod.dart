...
class EditProductScreen extends StatefulWidget {
  ...
  final String id, title, productCat, imageUrl;
...
class _EditProductScreenState extends State<EditProductScreen> {
      ...
      try {
        ...
        if (_pickedImage != null) {
          final ref = FirebaseStorage.instance
              ...
              .child(widget.id);
          final uploadFile =
              kIsWeb ? webImage : _pickedImage!.readAsBytesSync();
          final nameData = ref.putData(uploadFile);
          imageUri = await nameData.snapshot.ref.getDownloadURL();
        }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key: menuControllerProvider.getEditProductscaffoldKey,
                  ...
                  child: Column(
                    children: [
                      Header(
                        showText: false,
                        fct: () {
                          menuControllerProvider.controlEditProductsMenu();
                        },
                                    ...
                                    ButtonsWidget(
                                      onPressed: () async {
                                        GlobalMethods.warningDialog(
                                            title: 'Delete?',
                                            hintText: 'Press okay to confirm',
                                            function: () async {
                                              await FirebaseFirestore.instance
                                                  .collection('products')
                                                  .doc(widget.id)
        ...
        onChanged: (value) {
          if (value == '0') {
            ...
            setState(() {
              _salePercent = value;
              _salePrice =
                  widget.price - (double.parse(value!) * widget.price / 100);
            });
          }
        },
